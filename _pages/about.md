...
<div style="text-align: justify;">
  ...
  <p>He actively supports the Dosimetry Core Unit <a href="https://www.radboudumc.nl/en/research/at-departmental-level/imaging/dosimetry-core-unit" rel="external nofollow noopener" target="_blank">DCU</a>. The goal of the Dosimetry Core Unit (DCU) is to support effective and safe radionuclide therapy for cancer patients. To this aim, we perform translational research, covering the whole range from bench to bedside to community.</p>
