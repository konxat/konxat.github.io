...
profile:
  ...
  more_info: >
    ...
    <p><img src="https://img.shields.io/badge/Citations-411-orange" alt="Citations" style="height: 15px;" style="width: 80px;"/> <img src="https://img.shields.io/badge/Documents-27-blue" alt="Documents" style="height: 15px;" style="width: 70px;"/> <img src="https://img.shields.io/badge/h--index-9-green" alt="h-index" style="height: 15px;" style="width: 50px;"/></p>
...
<div style="text-align: justify;">
  ...
  <p>He actively supports the Dosimetry Core Unit (<a href="https://www.radboudumc.nl/en/research/at-departmental-level/imaging/dosimetry-core-unit" rel="external nofollow noopener" target="_blank">DCU</a>). The goal of the DCU is to support effective and safe radionuclide therapy for cancer patients. To this aim, we perform translational research, covering the whole range from bench to bedside to community.</p>
